...
def setup_and_start_tree(host_links):
    ...
    elems_per_chunk = 8000  # 8000 floats × 4 bytes × 16 hosts = 512000 bytes (500 KB)
    grad_elems = world_size * elems_per_chunk

    base_port = 5000
    ranks = {name: rank for rank, name in enumerate(ordered_names)}

    # Topology-aware two-level tree:
    #   L0: h_p0_e0_2 is the global root
    #       - intra-pod children (pod 0): h_p0_e0_3, h_p0_e1_2, h_p0_e1_3
    #       - inter-pod children (pod-roots): h_p1_e0_2, h_p2_e0_2, h_p3_e0_2
    #   L1: each pod-root gathers from its 3 local hosts (flat, parallel across pods)
    # Intra-pod reductions run in parallel before inter-pod traffic hits the core.
    children_by_name = {
        "h_p0_e0_2": ["h_p0_e0_3", "h_p0_e1_2", "h_p0_e1_3",
                       "h_p1_e0_2", "h_p2_e0_2", "h_p3_e0_2"],
        "h_p1_e0_2": ["h_p1_e0_3", "h_p1_e1_2", "h_p1_e1_3"],
        "h_p2_e0_2": ["h_p2_e0_3", "h_p2_e1_2", "h_p2_e1_3"],
        "h_p3_e0_2": ["h_p3_e0_3", "h_p3_e1_2", "h_p3_e1_3"],
    }
